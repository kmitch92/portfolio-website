          ...
          <Container fluid>
            ...
            >
              ...
              <Card.Body>
                ...
                over a decade; a time where I also pursued oil-painting and ran
                a boutique production company business. I am now pursuing
                Software Developer roles, where I hope to find use for both my
                creative and analytical faculties.
              </Card.Body>
              <Card.Footer>
                {' '}
                <Button
            ...
            >
              ...
              <Card.Body>
                My successes as a painter show my commitment to the pursuits
                that I engage in, the attention to detail that I apply to my
                projects, and the drive towards skill-mastery that animates my
                work.{' '}
              </Card.Body>
              <Card.Footer>
                {' '}
